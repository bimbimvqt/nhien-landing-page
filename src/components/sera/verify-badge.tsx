  ...
  gold: {
    icon: ({ className = "w-5 h-5" }: { className?: string }) => (
      <svg
        ...
        className={className}
      >
        <circle cx="12" cy="12" r="11" fill="url(#goldGradient)" fillOpacity="0.2" />
        <circle
          cx="12"
          cy="12"
          r="11"
...
export interface VerifyIconProps extends Omit<VerifyBadgeProps, "showLabel"> {}

const VerifyIcon = React.forwardRef<HTMLDivElement, VerifyIconProps>(
  (props, ref) => <VerifyBadge {...props} showLabel={false} ref={ref} />
);
VerifyIcon.displayName = "VerifyIcon";

export interface FloatingVerifyBadgeProps extends VerifyBadgeProps {
